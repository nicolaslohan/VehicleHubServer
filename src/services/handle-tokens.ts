...
export async function generateTokens(fastify: FastifyPluginCallbackZod, user: { id: number; email: string, name: string }) {
...
export async function revokeOldTokens(fastify: FastifyPluginCallbackZod, userId: number) {
