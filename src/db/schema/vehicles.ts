...
export const vehicles = pgTable('vehicles', {
    ...
    vehicle_model_id: bigint('vehicle_model_id', { mode: 'number' }).references(() => vehicle_models.id).notNull(),
    cost_center_id: bigint('cost_center_id', { mode: 'number' }).references(() => cost_centers.id).notNull(),
    vehicle_contract_id: bigint('vehicle_contract_id', { mode: 'number' }).references(() => vehicle_contracts.id).notNull(),
